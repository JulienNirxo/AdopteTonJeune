    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top"><img src="View/assets/img/logo.jpg">Adopte Ton Jeune</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="btn btn-primary" href="#about">Inscription</a></li>
                        <li class="nav-item"><a class="btn btn-primary" href="#about">Connexion</a></li>
                    </ul>
                </div>
            </div>
        </nav>
