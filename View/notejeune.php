...
<head>
    ...
    <link href="View/css/notejeune.css" rel="stylesheet" />
    <script src="View/js/homevieux.js"></script>
</head>
<body>
<!-- Navigation-->
    ...
    <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
        <div class="d-flex justify-content-center">
            <div class="text-center">
                <h1>Note</h1>
                <div class="card" id="enattente">
                    <div class="card-body" id="enattente">
                        <form method='post' action='homevieux.php'>
                            <label>Note : </label><select name="note" id="note">
                            ...
                            <input type="hidden" id="idjeune" name="idjeune" value="<?= $_POST['idjeune'] ?>">
                            <textarea class="form-control" id="avis" name="avis" rows="3" placeholder="Votre avis"></textarea>
